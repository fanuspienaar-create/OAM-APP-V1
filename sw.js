const CACHE='oam-studio-v4-1';
const APP=['./','./index.html','./manifest.webmanifest','./assets/oam-logo.webp','./assets/oam-icon.webp','./assets/oam-logo.png','./assets/oam-icon.png','./assets/oam-favicon.png'];
